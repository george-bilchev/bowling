package com.omnifix.demo.verifier;

/** @author nivedita */

/**
 * The frame class represents a single frame of the 10 - pin Bowling game score board. <br>
 * Each frame has 2 rolls. <br>
 * The total points for the frame is calculated after all rolls (including bonus rolls)
 */
public class Frame {
  ...
  /**
   * Instance variable to store the total points for the frame (including points from bonus rolls)
   */
  private int points;

  /**
   * Instance variable to denote if the frame was a Strike. <br>
   * Strike : When all ten pins are knocked down with the first ball , the player is awarded ten
   * pins, plus a bonus of whatever is scored with the next two rolls (not necessarily the next two
   * frames).
   *
   * <p>To be used to display the score board.
   */
  private boolean isStrike;

  /**
   * Instance variable to denote if the frame was a Spare. <br>
   * Spare : Awarded when a player uses both balls of a frame to clear all ten pins. A player
   * achieving a spare is awarded ten pins, plus a bonus of whatever is scored with the next roll
   * (not necessarily the next frame)
   *
   * <p>To be used to display the score board.
   */
